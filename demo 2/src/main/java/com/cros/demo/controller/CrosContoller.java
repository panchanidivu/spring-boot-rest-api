...
public class CrosContoller {
    ...
    //     Bandwidth limit = Bandwidth.classic(Long.parseLong(environment.getProperty("capacity")), Refill.intervally(Long.parseLong(environment.getProperty("time")), Duration.ofMinutes(Long.parseLong(environment.getProperty("interval")))));
